...
MODULE_SPECS: dict[str, ModuleSpec] = {
    "identity_access": ModuleSpec(
        ...
        import_prefixes=(
            ...
            "src.secrets.cache_and_rotation",
        ),
    ),
    ...
    "tool_management": ModuleSpec(
        ...
        import_prefixes=(
            ...
            "src.tools.plugins",
            "src.tools.sandbox",
            "src.resilience.compensation_hooks",
        ),
    ),
    "session_runtime": ModuleSpec(
        ...
        import_prefixes=(
            ...
            "src.core.agent_scaler",
            "src.core.background_runtime",
            "src.core.checkpoint_store",
            "src.core.scheduler",
            "src.core.task_graph",
    ...
    "turn_execution": ModuleSpec(
        ...
        import_prefixes=(
            ...
            "src.core.workflow_loader",
            "src.persistence.workflow_store",
            "src.resilience.retry_policy",
        ),
    ),
    ...
    "platform_bootstrap": ModuleSpec(
        ...
        import_prefixes=(
            ...
            "src.config.settings",
            "src.persistence.adapters.postgres",
            "src.persistence.adapters.sqlite",
            "src.persistence.factory",
            "src.persistence.migrations",
            "src.persistence.sqlite_connection",
        ),
    ),
    "shared_kernel": ModuleSpec(
        ...
        import_prefixes=(
            "src.schemas",
            "src.identity.contracts",
            "src.core.session_context",
            "src.persistence.contracts",
        ),
    ),
    "adapter_contracts": ModuleSpec(
        ...
        path_prefixes=(
            ...
            "src/tools/execution_adapter.py",
            "src/runtime/custom_runtime.py",
            "src/runtime/openai_agents_runtime.py",
            "src/runtime/openai_compatible_runtime.py",
            "src/runtime/tool_wiring.py",
        ),
        import_prefixes=(
            "src.runtime.runtime_adapter",
            "src.tools.execution_adapter",
            "src.runtime.custom_runtime",
            "src.runtime.openai_agents_runtime",
            "src.runtime.openai_compatible_runtime",
            "src.runtime.tool_wiring",
        ),
    ),
}
