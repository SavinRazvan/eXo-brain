...
Role: Enterprise-grade, evidence-only Python repository architecture audit protocol and eXo-brain workflow hooks.
Used By:
...
## eXo-brain workflow integration
...
- `docs/strategy/*`, `docs/plans/*`, `docs/architecture/*` for stated intent vs implementation.
- `scripts/pr/prepare.py` (`GATES`) for quality-gate reality.
...
- **Alignment / maintainer:** if findings are doc-policy-roadmap drift, also record P0/P1 items per `docs/roadmap/alignment-audit-schema.md` in `.local/workflow-artifacts/alignment/alignment-audit.md` and `alignment-todos.md` (advisory).
...
- Use **`docs/roadmap/alignment-audit-schema.md`** for finding shape and P0/P1/P2 handling.
