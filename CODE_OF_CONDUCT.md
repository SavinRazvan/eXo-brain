...
acceptable behavior and may remove, edit, or reject comments, commits, issues,
and other contributions that are not aligned with this Code of Conduct.

The maintainer may also temporarily or permanently ban contributors for behavior
that is considered inappropriate, threatening, offensive, or harmful.
...
reported to the maintainer through the contact channel listed in
[SECURITY.md](SECURITY.md) or the repository profile.
