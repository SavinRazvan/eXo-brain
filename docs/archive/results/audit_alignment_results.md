<!--
File: audit_alignment_results.md
Path: docs/archive/results/audit_alignment_results.md
Role: Historical snapshot of cross-source alignment findings.
Used By:
...
> Status: archived
> Canonical replacement: `.local/alignment-audit.md`
