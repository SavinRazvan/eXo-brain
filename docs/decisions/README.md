...
|---|---|---|
| [submit-tool-results-orchestrator-only.md](submit-tool-results-orchestrator-only.md) | Accepted (adapter **0.1.1+**, current **0.1.2**) | OpenAI adapter: orchestrator-owned tool continuation vs in-stream Agents SDK resume |
