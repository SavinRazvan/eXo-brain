...
Path: architecture-goals/EXECUTION_BOARD_12_GAPS.md
...
- `architecture-goals/NEXT_DIRECTIONS.md` (priority direction),
- `architecture-goals/TRACEABILITY_MATRIX.md` (strategy-to-code mapping),
- `architecture-goals/ADAPTER_STRATEGY.md` (adapter-specific rollout rules).
...
- traceability anchors are updated in `architecture-goals/TRACEABILITY_MATRIX.md`,
